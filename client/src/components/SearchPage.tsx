                            ...
                            <Card className="bg-white dark:bg-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                                <div className="relative">
                                    <AspectRatio ratio={16 / 6}>
                                        <img src={HeroImage} alt="image" className="w-full h-full object-cover" />
                                    </AspectRatio>
                                ...
                                <CardFooter className="p-4 dark:border-t-gray-700 border-t-gray-100 text-white justify-end">
